...
void CCfgFileParms::printPortGraph() {
	cout << "\nPort Graph" << endl;
	cout << "--------------------------------------------------------------------" << endl;
	for (int i = 0; i < linksSection.size(); i++) {
		cout << "			linksSection" << i + 1 << ": " << linksSection[i] << endl;
	}
	for (int i = 0; i < archSection.size(); i++) {
		cout << "			archSection" << i + 1 << ": " << archSection[i] << endl;
	}
	for (int i = 0; i < parmsSection.size(); i++) {
		cout << "			parmsSection" << i + 1 << ": " << parmsSection[i] << endl;
	}
	cout << "--------------------------------------------------------------------" << endl;
};
